...
<head>
	...
	<link rel="stylesheet" href="themes/table-detail.css"> <!-- css table-detail -->
	<!-- javascript -->
	<script src="//ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js"></script>
	<script src="themes/html2canvas.js"></script>
    <script src="themes/draw.js"></script>
    <script src="themes/lock.js"></script>
...
?>
<body style="background-color: white; background:none" id="MyBody">
<?php
...
$datan1=$datan2=$datan3=$datan4=$datan5=$datan6=$datan7=$datan8="";
if(!empty($val1)) :
...
?>
<div class="container" style="padding:20px 20px;border:1px solid #f7f7f7;background:#fff">
	<div class="row">
        <div class="col-sm-12"> 
		<div class="lead pull-right "></div>
		<h2 style="padding:5px; margin-bottom:0px;" id="cetak">Cetak <?=$array['modul'];?></h2>
		<div class="alerts" style="padding:5px; margin-bottom:0px;color:#fff;font-weight:bold"></div>
		</div>
		<div class="col-sm-6 "> 
		<div class="noPrint">
			<button id="btn-Preview-Image" type="button" class="btn btn-warning">Buat unduhan gambar</button>
			<a id="btn-Convert-Html2Image" class="btn btn-danger" href="#">Unduhan Gambar</a>
			<button type="button" class="btn btn-primary print" onClick="window.print()"><i class="fa fa-print" aria-hidden="true"></i> Print</button>	
		</div>
		</div>
		</div>
</div>
<div id="html-content-holder" class="container" style="padding:20px 20px;border:1px solid #f7f7f7;background:#fff">
		<div class="row">
        <div class="col-md-3"> 
		<table class='table table-striped' >
			...
			$array['jmlwarna'] . "/" . $array['jmlwarna2'] . ", " . $array['ketlam'] . ", ";
			 $nmfinishing1 = $nmfinishing2 = $nmfinishing3 = $nmfinishing4 = $nmfinishing5 = $nmfinishing6="";
...
<?php if(!empty($array2['hrgbhn'])){ 
				...
				$hitpot2 = hitung($lbr_pot2, $tinggi_pot2,$lbr_plano2,$tinggi_plano2 );	
...
<?php if(!empty($array3['hrgbhn'])){ 
				...
				$hitpot3 = hitung($lbr_pot3, $tinggi_pot3,$lbr_plano3,$tinggi_plano3 );	
...
<?php if(!empty($array4['hrgbhn'])){ 
				...
				$hitpot4 = hitung($lbr_pot4, $tinggi_pot4,$lbr_plano4,$tinggi_plano4 );	
...
<?php if(!empty($array5['hrgbhn'])){ 
				...
				$hitpot5 = hitung($lbr_pot5, $tinggi_pot5,$lbr_plano5,$tinggi_plano5 );	
...
<?php if(!empty($array6['hrgbhn'])){ 
				...
				$hitpot6 = hitung($lbr_pot6, $tinggi_pot6,$lbr_plano6,$tinggi_plano6 );	
...
<?php if(!empty($array7['hrgbhn'])){ 
				...
				$hitpot7 = hitung($lbr_pot7, $tinggi_pot7,$lbr_plano7,$tinggi_plano7 );	
...
<?php if(!empty($array8['hrgbhn'])){ 
				...
				$hitpot8 = hitung($lbr_pot8, $tinggi_pot8,$lbr_plano8,$tinggi_plano8 );	
...
<!-- Tampilkan jika level user adalah admin -->				
		...
		?> 
		)</td><td style="width:2%!important">Rp.</td><td style="width:15%!important" class="text-right"><?=rp($array['totcetak']);?></td></tr>	
...
<?php if ($array['tot_ctp'] > 0){ ?>			
		<tr><td>Plat/CTP (@<?=rp($array['ctp']);?>)</td><td>Rp.</td><td class="text-right"><?=rp($array['tot_ctp']);?></td></tr>
<?php } ?>		
...
<?php }else{ ?>
<tr><td>Ongk. Potong Kertas (Min Rp. <?=rp($array['hargapotmin']);?> - Lebih <?=rp($array['hargapot']);?>)</td><td>Rp.</td><td><?=rp($array['ongkos_potong']);?></td></tr>	
<?php }
} ?>		
...
<tr><td>Ongk. Potong Kertas</td><td>Rp.</td><td>0</td></tr>
<?php }else{ ?>
<tr><td>Ongk. Potong Kertas (Min Rp. <?=rp($array2['hargapotmin']);?> - Lebih <?=rp($array2['hargapot']);?>)</td><td>Rp.</td><td><?=rp($array2['ongkos_potong']);?></td></tr>	
<?php }
} ?>	
...
<tr><td>Ongk. Potong Kertas</td><td>Rp.</td><td>0</td></tr>
<?php }else{ ?>
<tr><td>Ongk. Potong Kertas (Min Rp. <?=rp($array3['hargapotmin']);?> - Lebih <?=rp($array3['hargapot']);?>)</td><td>Rp.</td><td><?=rp($array3['ongkos_potong']);?></td></tr>	
<?php }
} ?>
...
<tr><td>Ongk. Potong Kertas</td><td>Rp.</td><td>0</td></tr>
<?php }else{ ?>
<tr><td>Ongk. Potong Kertas (Min Rp. <?=rp($array4['hargapotmin']);?> - Lebih <?=rp($array4['hargapot']);?>)</td><td>Rp.</td><td><?=rp($array4['ongkos_potong']);?></td></tr>	
<?php }
} ?>		
...
<tr><td>Ongk. Potong Kertas</td><td>Rp.</td><td>0</td></tr>
<?php }else{ ?>
<tr><td>Ongk. Potong Kertas (Min Rp. <?=rp($array5['hargapotmin']);?> - Lebih <?=rp($array5['hargapot']);?>)</td><td>Rp.</td><td><?=rp($array5['ongkos_potong']);?></td></tr>	
<?php }
} ?>	
...
<tr><td>Ongk. Potong Kertas</td><td>Rp.</td><td>0</td></tr>
<?php }else{ ?>
<tr><td>Ongk. Potong Kertas (Min Rp. <?=rp($array6['hargapotmin']);?> - Lebih <?=rp($array6['hargapot']);?>)</td><td>Rp.</td><td><?=rp($array6['ongkos_potong']);?></td></tr>	
<?php }
} ?>	
...
<tr><td>Ongk. Potong Kertas</td><td>Rp.</td><td>0</td></tr>
<?php }else{ ?>
<tr><td>Ongk. Potong Kertas (Min Rp. <?=rp($array7['hargapotmin']);?> - Lebih <?=rp($array7['hargapot']);?>)</td><td>Rp.</td><td><?=rp($array7['ongkos_potong']);?></td></tr>	
<?php }
} ?>	
...
<tr><td>Ongk. Potong Kertas</td><td>Rp.</td><td>0</td></tr>
<?php }else{ ?>
<tr><td>Ongk. Potong Kertas (Min Rp. <?=rp($array8['hargapotmin']);?> - Lebih <?=rp($array8['hargapot']);?>)</td><td>Rp.</td><td><?=rp($array8['ongkos_potong']);?></td></tr>	
<?php }
} ?>	
...
<div class="container" style="border:1px solid #f7f7f7;background:#fff">
	<div class="row">
	<div id="editor"></div>
